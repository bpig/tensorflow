...
def setup_train_data_feeder(x, y, n_classes, batch_size=None, shuffle=True, epochs=None):
...
class StreamingDataFeeder(DataFeeder):
    ...
    def get_feed_dict_fn(self):
        ...
        Returns:
          A function that when called samples a random subset of batch size from x and y.
        """
        self.stopped = False
